...
Важно помнить, что перебазирование изменяет историю коммитов, поэтому будьте осторожны, если ваша ветка уже была опубликована и использована другими членами команды. 3. Если Git обнаружит конфликты при слиянии или перебазировании, вам придется разрешить их вручную. 4.
`git add . `
`git commit -m "Merge (или Rebase) with develop"`

- Старайтесь не забывать про `git rebase develop`
